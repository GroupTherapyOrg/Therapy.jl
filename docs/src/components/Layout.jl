    ...
    Div(:class => "min-h-screen flex flex-col bg-warm-50 dark:bg-warm-950 text-warm-800 dark:text-warm-200 transition-colors",
        ...
        Nav(:class => "border-b border-warm-200 dark:border-warm-800 px-6 py-4",
            Div(:class => "max-w-5xl mx-auto flex items-center justify-between",
                A(:href => "/", :class => "text-xl font-serif font-bold text-warm-900 dark:text-warm-100 hover:text-accent-600 dark:hover:text-accent-400 transition-colors",
                    "Therapy",
                    Span(:class => "text-accent-500", ".jl")
                ),
                Div(:class => "flex items-center gap-6",
                    A(:href => "/getting-started/", :class => "text-sm text-warm-600 dark:text-warm-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors", "Getting Started"),
                    A(:href => "/api/", :class => "text-sm text-warm-600 dark:text-warm-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors", "API"),
                    A(:href => "/examples/", :class => "text-sm text-warm-600 dark:text-warm-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors", "Examples"),
                    ...
                    Button(:class => "text-warm-500 dark:text-warm-400 hover:text-warm-700 dark:hover:text-warm-300 transition-colors",
                        :onclick => "document.documentElement.classList.toggle('dark'); localStorage.setItem(window.__therapy_theme_key || 'therapy-theme', document.documentElement.classList.contains('dark') ? 'dark' : 'light')",
