        ...
        Footer(:class => "border-t border-warm-200 dark:border-warm-800 px-6 py-6",
            Div(:class => "max-w-5xl mx-auto flex items-center justify-between",
                ...
                A(:href => "https://github.com/GroupTherapyOrg", :target => "_blank",
                    :class => "text-sm text-warm-500 dark:text-warm-400 hover:text-warm-700 dark:hover:text-warm-300 transition-colors no-underline",
                    "GroupTherapyOrg"
                ),
                # Center: package links
                Div(:class => "flex items-center gap-2 text-sm text-warm-400 dark:text-warm-500",
                    A(:href => "https://github.com/GroupTherapyOrg/Therapy.jl", :target => "_blank",
