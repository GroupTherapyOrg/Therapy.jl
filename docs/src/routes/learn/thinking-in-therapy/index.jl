...
function ThinkingInTherapy()
    TutorialLayout(
        Div(:class => "space-y-12",
            ...
            # Key Insight Box
            Div(:class => "bg-gradient-to-r from-emerald-100 to-emerald-200 dark:from-emerald-950/30 dark:to-emerald-900/30 rounded-lg p-6 mb-8",
                H2(:class => "text-lg font-semibold font-serif text-neutral-900 dark:text-neutral-100 mb-2",
                    "The Core Insight"
                ),
            ...
            Section(
                ...
                Div(:class => "grid md:grid-cols-2 gap-6 mb-6",
                    # React/VDOM approach
                    Div(:class => "bg-neutral-50 dark:bg-neutral-900 rounded-lg p-6 border border-neutral-300 dark:border-neutral-800",
...
function Counter()
    ...
    return Div(
        ...
        Span(count)  # Re-created each time
                    ...
                    Div(:class => "bg-neutral-50 dark:bg-neutral-900 rounded-lg p-6 border-2 border-emerald-200 dark:border-emerald-800",
                        H3(:class => "text-lg font-semibold font-serif text-emerald-700 dark:text-emerald-400 mb-3",
...
function Counter()
    ...
    return Div(
        ...
        Span(count)  # Creates subscription, updates directly
                ...
                # Visual diagram
                Div(:class => "bg-neutral-50 dark:bg-neutral-900 rounded-lg p-6 text-center",
                    ...
                    Div(:class => "flex justify-around items-center flex-wrap gap-4",
                        ...
                        Div(:class => "text-2xl text-neutral-300", "vs"),
                        Div(:class => "text-center",
                            Div(:class => "text-3xl mb-2 text-emerald-600 dark:text-emerald-400", "Therapy.jl"),
                            Div(:class => "text-sm text-neutral-600 dark:text-neutral-400",
    ...
    (category="Vegetables", price="\$1", stocked=true, name="Peas")
                ...
                Ul(:class => "space-y-2 text-neutral-700 dark:text-neutral-300 ml-4",
...
function ProductCategoryRow(category)
    Tr(
        Th(:colspan => "2", :class => "font-bold bg-neutral-100", category)
    )
end
    ...
    Div(
        ...
        ProductTable(products)
            ...
            Section(
                ...
                Ol(:class => "list-decimal list-inside text-neutral-700 dark:text-neutral-300 space-y-2 mb-4 ml-4",
                ...
                Ul(:class => "space-y-2 text-neutral-700 dark:text-neutral-300 ml-4 mb-4",
                ...
                Div(:class => "bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 mb-4",
                    P(:class => "text-neutral-700 dark:text-neutral-300 text-sm",
                        ...
                        "2. Search text — changes over time → ", Strong(:class => "text-emerald-700 dark:text-emerald-400", "signal"), Br(),
                        "3. Checkbox value — changes over time → ", Strong(:class => "text-emerald-700 dark:text-emerald-400", "signal"), Br(),
        ...
        matches_search && matches_stock
                ...
                Div(:class => "bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded p-4 mt-4",
                    P(:class => "text-emerald-800 dark:text-emerald-200 text-sm",
                        Strong("Key insight: "),
                        "In Therapy.jl, ", Code(:class => "bg-emerald-100 dark:bg-emerald-800 px-1 rounded", "create_memo"),
    ...
    Form(
        ...
        Label(
            ...
            Section(
                ...
                Div(:class => "grid md:grid-cols-2 gap-6 mb-6",
                    # React way
                    Div(:class => "bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 border border-neutral-300 dark:border-neutral-800",
                        H4(:class => "font-semibold text-neutral-700 dark:text-neutral-300 mb-2 text-sm", "React: Callback Props"),
...
/>""")
                    ...
                    # Therapy.jl way
                    Div(:class => "bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 border-2 border-emerald-200 dark:border-emerald-800",
                        H4(:class => "font-semibold text-emerald-700 dark:text-emerald-400 mb-2 text-sm", "Therapy.jl: Direct Setters"),
...
# No JavaScript interpreter overhead for game logic."""),
            ...
            Div(:class => "bg-neutral-50 dark:bg-neutral-900 rounded-lg p-6 mt-8",
                ...
                P(:class => "text-neutral-700 dark:text-neutral-300 text-sm mb-3",
                ...
                P(:class => "text-neutral-500 dark:text-neutral-500 text-sm mt-3 italic",
                    "Therapy.jl brings this proven model to Julia, with the unique advantage of compiling Julia code directly to WebAssembly."
                )
            ),

            # Next steps
            Div(:class => "bg-gradient-to-r from-emerald-100 to-emerald-200 dark:from-emerald-950/30 dark:to-emerald-900/30 rounded-lg p-6 mt-8",
                H3(:class => "text-lg font-semibold font-serif text-neutral-900 dark:text-neutral-100 mb-3",
                    "Next Steps"
                ),
...
function SummaryPoint(number, title, description)
    Div(:class => "flex gap-4 items-start",
        Div(:class => "w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 flex items-center justify-center font-bold shrink-0",
            number
        ),
        Div(
            H4(:class => "font-semibold text-neutral-900 dark:text-neutral-100 mb-1", title),
            P(:class => "text-neutral-700 dark:text-neutral-300 text-sm", description)
        )
    )
end
