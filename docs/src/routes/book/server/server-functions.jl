...
function Index()
    Fragment(
        ...
        Section(:class => "py-12",
            ...
            Ol(:class => "list-decimal list-inside space-y-2 text-neutral-600 dark:text-neutral-400 mb-6",
...
result = create_post("Hello", "World")"""),
            P(:class => "text-neutral-600 dark:text-neutral-400 mt-4",
                "Behind the scenes, ", Code(:class => "text-emerald-700 dark:text-emerald-400", "@server"),
                " does two things:"
            ),
            Ol(:class => "list-decimal list-inside space-y-1 text-neutral-600 dark:text-neutral-400 mt-2",
        ...
        Section(:class => "py-12",
            ...
            P(:class => "text-lg text-neutral-600 dark:text-neutral-300 mb-6",
                "Clients call server functions via the ", Code(:class => "text-emerald-700 dark:text-emerald-400", "TherapyWS.callServer"),
                " JavaScript API:"
            ),
        ...
        "message": "User not found"
            ...
            Div(:class => "overflow-x-auto",
                Table(:class => "w-full text-left",
                    Thead(
                        Tr(
                            Th(:class => "py-2 px-4 text-neutral-700 dark:text-neutral-300", "Code"),
                            Th(:class => "py-2 px-4 text-neutral-700 dark:text-neutral-300", "Meaning")
                        )
                    ),
                    Tbody(:class => "text-neutral-600 dark:text-neutral-400",
                        Tr(
                            Td(:class => "py-2 px-4", Code(:class => "text-emerald-700 dark:text-emerald-400", "not_found")),
                            Td(:class => "py-2 px-4", "Function name not registered")
                        ),
                        Tr(
                            Td(:class => "py-2 px-4", Code(:class => "text-emerald-700 dark:text-emerald-400", "validation")),
                            Td(:class => "py-2 px-4", "Wrong number of arguments")
                        ),
                        Tr(
                            Td(:class => "py-2 px-4", Code(:class => "text-emerald-700 dark:text-emerald-400", "execution")),
                            Td(:class => "py-2 px-4", "Error thrown during function execution")
                        ),
                        Tr(
                            Td(:class => "py-2 px-4", Code(:class => "text-emerald-700 dark:text-emerald-400", "timeout")),
                            Td(:class => "py-2 px-4", "Response not received within timeout")
                        ),
                        Tr(
                            Td(:class => "py-2 px-4", Code(:class => "text-emerald-700 dark:text-emerald-400", "not_connected")),
            ...
            Div(:class => "grid md:grid-cols-2 gap-8",
                Div(
                    ...
                    Ul(:class => "space-y-1 text-neutral-600 dark:text-neutral-400",
                        Li(Code(:class => "text-emerald-700 dark:text-emerald-400", "Int, Float64"), " → JSON number"),
                        Li(Code(:class => "text-emerald-700 dark:text-emerald-400", "String"), " → JSON string"),
                        Li(Code(:class => "text-emerald-700 dark:text-emerald-400", "Bool"), " → JSON boolean"),
                        Li(Code(:class => "text-emerald-700 dark:text-emerald-400", "nothing"), " → JSON null"),
                        Li(Code(:class => "text-emerald-700 dark:text-emerald-400", "Vector{T}"), " → JSON array"),
                        Li(Code(:class => "text-emerald-700 dark:text-emerald-400", "Dict{String,T}"), " → JSON object"),
                        Li(Code(:class => "text-emerald-700 dark:text-emerald-400", "Structs"), " → JSON object (with JSON3)")
                    )
                ),
                Div(
                    H3(:class => "text-lg font-serif font-semibold text-neutral-800 dark:text-neutral-200 mb-4",
