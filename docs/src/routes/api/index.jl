() -> begin
    Div(:class => "space-y-10",
        ...
        H2(:class => "text-xl font-semibold text-warm-800 dark:text-warm-200", "Reactivity"),
        Div(:class => "space-y-4",
            Div(:class => "border border-warm-200 dark:border-warm-800 rounded-lg p-5",
                ...
                P(:class => "text-sm text-warm-500 dark:text-warm-400 mt-1", "Create a reactive signal. Returns (getter, setter) tuple.")),
            Div(:class => "border border-warm-200 dark:border-warm-800 rounded-lg p-5",
                H3(:class => "font-mono font-semibold text-warm-900 dark:text-warm-100", "create_effect(() -> ...)"),
                P(:class => "text-sm text-warm-500 dark:text-warm-400 mt-1", "Run a side effect that re-runs when dependencies change.")),
            Div(:class => "border border-warm-200 dark:border-warm-800 rounded-lg p-5",
