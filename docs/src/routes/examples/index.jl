    ...
    Div(:class => "max-w-4xl mx-auto",
            ...
            Section(:class => "text-center",
                ...
                A(:href => "https://github.com/TherapeuticJulia/Therapy.jl/tree/main/examples",
                  :class => "inline-flex items-center gap-2 bg-warm-900 dark:bg-warm-800 text-white px-6 py-3 rounded-lg hover:bg-warm-800 dark:hover:bg-warm-600 transition-colors",
                  :target => "_blank",
...
function ExampleCard(title, description, href, available)
    Div(:class => "bg-warm-100 dark:bg-warm-800 rounded-lg p-6 border border-warm-200 dark:border-warm-900" * (available ? " hover:border-accent-200 dark:hover:border-accent-900" : " opacity-60"),
        ...
        available ?
            A(:href => href, :class => "text-accent-400 dark:text-accent-500 hover:text-accent-500 dark:hover:text-accent-400 text-sm font-medium", "View example →") :
