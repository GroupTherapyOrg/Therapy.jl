        ...
        Div(:class => "max-w-4xl mx-auto",
            ...
            Div(:class => "bg-orange-100/50 dark:bg-yellow-950/30 rounded-xl p-8 mb-8",
                Div(:class => "flex items-center gap-4 mb-4",
                    Div(:class => "w-12 h-12 bg-orange-200 dark:bg-yellow-950/50 rounded-lg flex items-center justify-center",
                        Svg(:class => "w-6 h-6 text-orange-500 dark:text-yellow-500", :fill => "none", :viewBox => "0 0 24 24", :stroke => "currentColor", :stroke_width => "2",
            ...
            Section(:class => "text-center",
                ...
                A(:href => "https://github.com/TherapeuticJulia/Therapy.jl/tree/main/examples",
                  :class => "inline-flex items-center gap-2 bg-stone-800 dark:bg-stone-700 text-white px-6 py-3 rounded-lg hover:bg-stone-700 dark:hover:bg-stone-600 transition-colors",
                  :target => "_blank",
...
function ExampleCard(title, description, href, available)
    Div(:class => "bg-white dark:bg-stone-800 rounded-xl p-6 border border-stone-200 dark:border-stone-700" * (available ? " hover:border-orange-200 dark:hover:border-yellow-900" : " opacity-60"),
        ...
        available ?
            A(:href => href, :class => "text-orange-400 dark:text-yellow-500 hover:text-orange-500 dark:hover:text-yellow-400 text-sm font-medium", "View example →") :
            Span(:class => "text-stone-400 dark:text-stone-500 text-sm", "Coming soon")
    )
end
