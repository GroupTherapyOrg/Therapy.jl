...
(a) **"Software"** means the Therapy.jl software and all associated packages, documentation, source code, specifications, algorithms, libraries, and binary and/or executable code included in the distribution, and any modifications, updates, or improvements made thereto by Licensor.
...
**Q: I'm building an open source project that depends on Therapy.jl. Is that okay?**
...
A: Email me. I'd rather have you using Therapy.jl with a discounted license than not using it at all. We'll figure something out.
